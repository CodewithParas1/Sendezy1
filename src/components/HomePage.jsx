...
const HomePage = () => {
  return (
    ...
    className="w-full min-h-screen pt-1 relative overflow-hidden"
  >
    {/* Video Background */}
    <video
    ...
    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between min-h-screen px-4 sm:px-6 md:px-12">
      ...
      <div className="flex-1 relative mt-6 md:mt-0 flex justify-center items-center">
        <div className="bg-white shadow-lg rounded-2xl p-6 w-full max-w-xs sm:max-w-sm mx-auto">
          ...
          {/* Fee Structure */}
          <div>
              <h3 className="text-blue-600 font-semibold font-lexend mb-4 text-xs sm:text-sm lg:text-base">
                Fee Structure
              </h3>
              <div className="text-xs sm:text-sm lg:text-base text-gray-600 space-y-3">
                ...
                <p className="flex justify-between text-xl font-lexend font-semibold text-gray-800">
            ...
            {/* Send Money Button */}
            <button className="bg-yellow-400 text-black font-semibold font-lexend px-4 py-5 rounded-lg w-full mt-9 hover:bg-yellow-500 text-xs sm:text-sm lg:text-base transition-all duration-300 hover:scale-95">
              Send Money
            </button>
        </div>
      </div>
